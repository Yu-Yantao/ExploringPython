# 随机森林：原理：同时训练很多棵决策树（每棵只看部分数据和特征），最后投票决定结果。
# 类比：让100个人分别做判断，取多数人的答案，比1个人的判断更靠谱
...
def parse_args():
    ...
    parser.add_argument("--max_depth", type=str, default="", help="每棵树的最大深度")
    return parser.parse_args()


def create_model(hyper_params):
    return RandomForestClassifier(**hyper_params, random_state=42)
